...
\printbibliography[nottype=online,nottype=customa, heading=bibintoc,title={\langde{Literaturverzeichnis}\langen{Bibliography}}]
...
% neue Seite für KI-Quellen-Verzeichnis
\newpage
% KI-Quellen-Verzeichnis anzeigen.
\printbibliography[type=customa,heading=subbibliography,title={\headingNameAiSources}]
